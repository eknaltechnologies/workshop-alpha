...
def recommend_music():
    ...
    songs = Song.query.filter_by(mood=selected_mood).all()

    return render_template("results.html", songs=songs, mood=selected_mood)
...
def all_songs():
    ...
    return render_template("results.html", songs=songs, mood="All Songs")
